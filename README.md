...
* The Infrastructure Disconnect:** Higher infrastructure allocation in a state does not inherently guarantee a proportionally higher electricity access rate for its population.
* **Regional Variance:** Electricity infrastructure distribution varies massively depending on the state.

## 🖥️ Dashboard Features
* Interactive Year & Plant Type Slicers
* Geographic Map Visualization
* High-Level Metric KPI Cards
* Infrastructure vs. Access Scatter Plot Analysis
* State-by-State Column Bar Chart Analysis
* Energy Generation Mix Donut Chart
